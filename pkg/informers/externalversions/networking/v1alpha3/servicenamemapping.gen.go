...
type ServiceNameMappingInformer interface {
	...
	Lister() v1alpha3.ServiceNameMappingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha3().ServiceNameMappings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha3().ServiceNameMappings(namespace).Watch(context.TODO(), options)
			},
		},
		&networkingv1alpha3.ServiceNameMapping{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceNameMappingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1alpha3.ServiceNameMapping{}, f.defaultInformer)
}

func (f *serviceNameMappingInformer) Lister() v1alpha3.ServiceNameMappingLister {
	return v1alpha3.NewServiceNameMappingLister(f.Informer().GetIndexer())
}
