...
type ServiceNameMappingInformer interface {
	...
	Lister() v1beta1.ServiceNameMappingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1beta1().ServiceNameMappings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1beta1().ServiceNameMappings(namespace).Watch(context.TODO(), options)
			},
		},
		&networkingv1beta1.ServiceNameMapping{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceNameMappingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1beta1.ServiceNameMapping{}, f.defaultInformer)
}

func (f *serviceNameMappingInformer) Lister() v1beta1.ServiceNameMappingLister {
	return v1beta1.NewServiceNameMappingLister(f.Informer().GetIndexer())
}
