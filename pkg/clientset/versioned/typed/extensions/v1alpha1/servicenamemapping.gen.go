...
type ServiceNameMappingInterface interface {
	...
	UpdateStatus(ctx context.Context, serviceNameMapping *v1alpha1.ServiceNameMapping, opts v1.UpdateOptions) (*v1alpha1.ServiceNameMapping, error)
	...
	Apply(ctx context.Context, serviceNameMapping *extensionsv1alpha1.ServiceNameMappingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ServiceNameMapping, err error)
	ApplyStatus(ctx context.Context, serviceNameMapping *extensionsv1alpha1.ServiceNameMappingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ServiceNameMapping, err error)
...
func newServiceNameMappings(c *ExtensionsV1alpha1Client, namespace string) *serviceNameMappings {
...
func (c *serviceNameMappings) UpdateStatus(ctx context.Context, serviceNameMapping *v1alpha1.ServiceNameMapping, opts v1.UpdateOptions) (result *v1alpha1.ServiceNameMapping, err error) {
	result = &v1alpha1.ServiceNameMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicenamemappings").
...
func (c *serviceNameMappings) Apply(ctx context.Context, serviceNameMapping *extensionsv1alpha1.ServiceNameMappingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ServiceNameMapping, err error) {
...
func (c *serviceNameMappings) ApplyStatus(ctx context.Context, serviceNameMapping *extensionsv1alpha1.ServiceNameMappingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ServiceNameMapping, err error) {
	if serviceNameMapping == nil {
		return nil, fmt.Errorf("serviceNameMapping provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
