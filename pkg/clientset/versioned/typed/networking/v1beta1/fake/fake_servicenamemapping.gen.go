...
var servicenamemappingsResource = schema.GroupVersionResource{Group: "networking.istio.io", Version: "v1beta1", Resource: "servicenamemappings"}

var servicenamemappingsKind = schema.GroupVersionKind{Group: "networking.istio.io", Version: "v1beta1", Kind: "ServiceNameMapping"}
...
func (c *FakeServiceNameMappings) UpdateStatus(ctx context.Context, serviceNameMapping *v1beta1.ServiceNameMapping, opts v1.UpdateOptions) (*v1beta1.ServiceNameMapping, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(servicenamemappingsResource, "status", c.ns, serviceNameMapping), &v1beta1.ServiceNameMapping{})
...
func (c *FakeServiceNameMappings) Apply(ctx context.Context, serviceNameMapping *networkingv1beta1.ServiceNameMappingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ServiceNameMapping, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(servicenamemappingsResource, c.ns, *name, types.ApplyPatchType, data), &v1beta1.ServiceNameMapping{})
...
func (c *FakeServiceNameMappings) ApplyStatus(ctx context.Context, serviceNameMapping *networkingv1beta1.ServiceNameMappingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ServiceNameMapping, err error) {
	if serviceNameMapping == nil {
		return nil, fmt.Errorf("serviceNameMapping provided to Apply must not be nil")
	}
	data, err := json.Marshal(serviceNameMapping)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(servicenamemappingsResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1beta1.ServiceNameMapping{})
